...
[@fotheringham2003geographically;, @harris2010robust], heteroskedastic [@fotheringham2003geographically; @paez2002general; @paez2002general2], ridge [@wheeler2007diagnostic; @gollini2015gwmodel], LASSO [@wheeler2009simultaneous] and elastic net form [@li2018geographically; @comber2018geographically]. Further extensions include time in the form of geographically and temporally weighted regression (GTWR) [@huang2010geographically; @fotheringham2015geographical], area to point regression [@murakami2015area], multiple scales of analysis [@yang2014extension; @fotheringham2017multiscale], spatially variable model specification [@comber2018hyper] and the use of different distance metrics [@lu2016minkowski].
...
knitr::kable(df,
             caption = "The presence of GWmodel package functionality by the main groups of related functions (* for mean/median only), where applicable.",
